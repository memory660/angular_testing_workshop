...
describe('CounterApiService', () => {
  ...
  /*
  HttpTestingController : Cette classe fait partie du module HttpClientTestingModule.
  Ce contrôleur possède des méthodes pour trouver des demandes selon différents critères. La plus simple est expectOne
  */
